...
def create_chart(ds_id: int, chart_name: str, viz_type: str,
    ...
    if resp.status_code != 200:
        logger.warning(f'Cannot login for chart: {resp.status_code}')
        return 0
...
def create_dashboard(title: str, slug: str, description: str,
    ...
    """Tạo dashboard qua REST API (với field names tương thích Superset 3.x)."""
    import requests
    ...
    # Superset 3.x uses slug and dashboard_title, position as json string
    payload = {
