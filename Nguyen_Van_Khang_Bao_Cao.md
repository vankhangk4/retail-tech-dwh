...
| ![logo][image1] |  TRƯỜNG ĐẠI HỌC THUỶ LỢI  KHOA CÔNG NGHỆ THÔNG TIN  ĐỀ CƯƠNG ĐỒ ÁN TỐT NGHIỆP   |
| :---: | :---: |
...
*Mã sinh viên:* 2251162042

*Số điện thoại:* 0977159653
...
Tôi xin cam đoan đồ án tốt nghiệp này là công trình nghiên cứu của riêng tôi. Các số liệu, kết quả trình bày trong đồ án là trung thực và chưa từng được ai công bố trong bất kỳ công trình nào khác.

Tôi xin cam đoan rằng mọi sự giúp đỡ cho việc thực hiện đồ án này đã được cảm ơn và các thông tin trích dẫn trong đồ án đều được chỉ rõ nguồn gốc.
...
Trong suốt quá trình thực hiện đồ án tốt nghiệp, tôi đã nhận được sự hỗ trợ và định hướng quý báu từ nhiều người. Tôi xin bày tỏ lòng biết ơn sâu sắc đến:

Thầy TS. Đỗ Oanh Cường — Giáo viên hướng dẫn trực tiếp của tôi — đã tận tình chỉ bảo, góp ý và định hướng trong suốt quá trình nghiên cứu và hoàn thiện đồ án.

Quý thầy, cô trong Khoa Công nghệ Thông tin, Trường Đại học Thuỷ Lợi đã trang bị cho tôi những kiến thức nền tảng vững chắc trong suốt bốn năm học tập.

Gia đình và bạn bè đã luôn bên cạnh, động viên và tạo mọi điều kiện thuận lợi để tôi hoàn thành đồ án này.

Mặc dù đã cố gắng hết sức, đồ án không tránh khỏi những thiếu sót. Tôi rất mong nhận được sự góp ý của thầy cô và hội đồng phản biện để đồ án được hoàn thiện hơn.
...
Hình 2.1: Biểu đồ Use Case tổng quát — Actor và các chức năng chính...

Hình 2.2: Sequence Diagram — UC02: Xem Dashboard Phân tích Doanh thu...

Hình 2.3: Sequence Diagram — UC06: Chạy ETL Pipeline...

Hình 3.1: Sơ đồ Kiến trúc Tổng thể 5 Tầng (Auth Gateway → BI Layer)...

Hình 4.1: Sơ đồ Star Schema Core — FactSales và các Dimension...

Hình 4.2: Sơ đồ ERD Multi-Tenant — Bảng Tenants, AppUsers và các thực thể...

Hình 5.1: Luồng xử lý ETL Pipeline — Extract, Transform, Load...

Hình 6.1: Luồng xác thực Auth Gateway — FastAPI/JWT...

Hình 6.2: Sơ đồ Luồng Hoạt động End-to-End (Bước 1–8)...

**DANH MỤC BẢNG BIỂU**

Bảng 1.1: Phân tích Hệ thống Nguồn Dữ liệu hiện tại...

Bảng 2.1: Xác định các Actor (Tác nhân)...

Bảng 2.2: Đặc tả Use Case UC01 — Đăng nhập Auth Gateway...

Bảng 2.3: Đặc tả Use Case UC02 — Xem Dashboard Phân tích Doanh thu...

Bảng 2.4: Đặc tả Use Case UC06 — Chạy ETL Pipeline...

Bảng 2.5: Bảng Yêu cầu Phi chức năng (NFR-01 đến NFR-12)...

Bảng 3.1: Stack Công nghệ và Phiên bản sử dụng...

Bảng 4.1: Cấu trúc bảng Tenants...

Bảng 4.2: Cấu trúc bảng AppUsers...

Bảng 4.3: Cấu trúc bảng DimDate — Chiều Thời gian...

Bảng 4.4: Cấu trúc bảng DimProduct — Chiều Sản phẩm (SCD Type 2)...

Bảng 4.5: Cấu trúc bảng DimCustomer — Chiều Khách hàng...

Bảng 4.6: Cấu trúc bảng DimStore — Chiều Cửa hàng...

Bảng 4.7: Cấu trúc bảng DimEmployee — Chiều Nhân viên...

Bảng 4.8: Cấu trúc bảng DimSupplier — Chiều Nhà cung cấp...

Bảng 4.9: Cấu trúc bảng FactSales — Sự kiện Bán hàng...

Bảng 4.10: Cấu trúc bảng FactInventory — Sự kiện Tồn kho...

Bảng 4.11: Cấu trúc bảng FactPurchase — Sự kiện Nhập hàng...

Bảng 5.1: Danh mục các Phép biến đổi trong bước Transform...

Bảng 5.2: Thứ tự Nạp Dữ liệu vào DWH...

Bảng 6.1: Chính sách Backup và Disaster Recovery...

Bảng 6.2: Luồng Hoạt động End-to-End (8 bước)...

**TÀI LIỆU THAM KHẢO**

\[1\] R. Kimball và M. Ross, The Data Warehouse Toolkit: The Definitive Guide to Dimensional Modeling, 3rd ed. Indianapolis, IN: John Wiley & Sons, 2013\.

\[2\] W. H. Inmon, Building the Data Warehouse, 4th ed. Indianapolis, IN: John Wiley & Sons, 2005\.

\[3\] Microsoft, "SQL Server 2019 Documentation," Microsoft Docs, 2022\. \[Online\]. Available: https://docs.microsoft.com/en-us/sql/sql-server/

\[4\] Apache Software Foundation, "Apache Superset Documentation," Apache Superset, 2024\. \[Online\]. Available: https://superset.apache.org/docs/

\[5\] S. Raschka và V. Mirjalili, Python Machine Learning, 3rd ed. Birmingham: Packt Publishing, 2019\.

\[6\] FastAPI, "FastAPI Documentation," 2024\. \[Online\]. Available: https://fastapi.tiangolo.com/

\[7\] Docker Inc., "Docker Documentation," 2024\. \[Online\]. Available: https://docs.docker.com/

\[8\] M. Jones, J. Bradley và N. Sakimura, "RFC 7519 — JSON Web Token (JWT)," Internet Engineering Task Force (IETF), 2015\.

\[9\] OWASP Foundation, "OWASP Top Ten," 2021\. \[Online\]. Available: https://owasp.org/www-project-top-ten/

\[10\] pandas Development Team, "pandas Documentation," 2024\. \[Online\]. Available: https://pandas.pydata.org/docs/

\[11\] SQLAlchemy, "SQLAlchemy 2.0 Documentation," 2024\. \[Online\]. Available: https://docs.sqlalchemy.org/

\[12\] PyJWT, "PyJWT Documentation," 2024\. \[Online\]. Available: https://pyjwt.readthedocs.io/
...
Hỗ trợ đa người dùng (Multi-Tenant): Nhiều cửa hàng/chi nhánh dùng chung hạ tầng, mỗi đơn vị chỉ truy cập dữ liệu của mình.
...
Xây dựng cơ sở dữ liệu Data Warehouse trên SQL Server với mô hình Star Schema, đảm bảo lưu trữ hàng triệu bản ghi giao dịch.

Triển khai quy trình ETL tự động có khả năng thu thập dữ liệu từ nhiều nguồn không đồng nhất.

Xây dựng các bảng Dimension và Fact phản ánh đầy đủ các thực thể kinh doanh.

Triển khai Apache Superset làm nền tảng BI, xây dựng ít nhất 5 Dashboard tương tác phân tích KPIs.

Xây dựng hệ thống phân quyền đa người dùng (multi-tenant): mỗi cửa hàng chỉ xem dữ liệu của mình; admin quản lý toàn bộ.

Đảm bảo hiệu năng truy vấn dưới 3 giây cho báo cáo tổng hợp thông thường.
...
### **2.1.3. Nhóm Chức năng Quản lý Người dùng Đa Tenant**
...
## **![][image4]2.2. Yêu cầu Phi chức năng**
...
| NFR-06 | Bảo mật (Security) | Xác thực và phân quyền | JWT HS256, bcrypt password hash, RBAC \+ RLS theo tenant\_id |
| NFR-07 | Bảo mật (Security) | Truyền dữ liệu | HTTPS bắt buộc cho toàn bộ API và Superset endpoint |
| NFR-08 | Bảo mật (Security) | JWT Token expiry | Access token hết hạn sau 8 giờ, refresh token sau 7 ngày |
| NFR-09 | Khả năng mở rộng (Scalability) | Thêm tenant mới | Không cần thay đổi kiến trúc — chỉ INSERT vào bảng Tenants |
...
| NFR-12 | Giám sát (Monitoring) | Alert khi ETL thất bại | Gửi email/Slack trong vòng 5 phút khi ETL status \= FAILED |
...
| :---- | :---- | :---- | :---- |
| Auth Gateway | FastAPI | 0.110+ | REST API xác thực, cấp JWT, tạo Superset guest token |
...
| Containerization | Docker \+ Docker Compose | Latest | Service: superset, superset-db, superset-redis, api |
| Monitoring — Alert | Python smtplib \+ Slack Webhook | — | Gửi email/Slack khi ETL FAILED trong vòng 5 phút |
...
## **4.2. Bảng Quản lý Tenant và Người dùng**
...
| TenantID | VARCHAR(20) | NOT NULL | — | FK → Tenants — Cửa hàng sở hữu khách hàng |
...
| EffectiveDate | DATE | NOT NULL | GETDATE() | Ngày bắt đầu hiệu lực (SCD Type 2\) |
| ExpirationDate | DATE | NULL | — | Ngày hết hiệu lực — NULL \= bản ghi hiện tại (SCD2) |
| IsCurrent | BIT | NOT NULL | 1 | Cờ bản ghi hiện tại (SCD Type 2\) |
...
| TenantID | VARCHAR(20) | NOT NULL | — | FK → Tenants — Mã tenant/chi nhánh |
...
| TenantID | VARCHAR(20) | NOT NULL | — | FK → Tenants — Mã tenant/cửa hàng |
...
| TenantID | VARCHAR(20) | NOT NULL | — | FK → Tenants — Row-Level isolation |
...
| TenantID | VARCHAR(20) | NOT NULL | — | FK → Tenants |
...
## **4.7. Script SQL — Tạo Cấu trúc Multi-Tenant**
...
CREATE VIEW v\_FactSales\_ByTenant AS
    ...
    WHERE TenantID \= ISNULL(CAST(SESSION\_CONTEXT(N'tenant\_id') AS VARCHAR(20)), '\#\#INVALID\#\#');  \-- Neu SESSION\_CONTEXT chua set \=\> tra 0 dong, khong loi am tham
...
### **4.8. Bổ sung DDL — STG\_CustomerRaw**
...
\-- Bảng Staging cho dữ liệu khách hàng thô
...
### **4.9. Bổ sung DDL — ETLLogs / ETL\_RunLog**
...
\-- Bảng ghi lich su moi lan chay ETL
...
### **4.10. Bổ sung Index cho DM\_SalesSummary**
...
\-- Index cho DM layer \-- can thiet de dashboard dat NFR-01 (\<= 3s)
...
### **4.11. Bổ sung Unique Index SCD2 cho DimCustomer**

Đảm bảo mỗi (TenantID, CustomerCode) chỉ có đúng 1 bản ghi IsCurrent=1, tránh SP lookup trả về nhiều dòng:

\-- Filtered unique index: moi khach hang chi co 1 ban ghi hien tai
...
CREATE TABLE ETL\_Watermark (
    ...
    TenantID     VARCHAR(20) NOT NULL REFERENCES Tenants(TenantID),  \-- FK ro rang

    TableName    VARCHAR(100) NOT NULL,  \-- Doi ten: ro hon SourceName

    LastRunTime  DATETIME2 NULL,         \-- Thoi diem ETL thanh cong cuoi cung

    LastRunStatus VARCHAR(20) NOT NULL DEFAULT 'PENDING'

        CHECK (LastRunStatus IN ('PENDING','RUNNING','SUCCESS','FAILED')),  \--

    UpdatedAt    DATETIME2 NOT NULL DEFAULT GETDATE(),

    CONSTRAINT UQ\_ETL\_Watermark UNIQUE (TenantID, TableName)  \--

);

CREATE INDEX IX\_ETL\_Watermark\_Tenant ON ETL\_Watermark(TenantID, TableName);

\-- Cac cot RowsExtracted, Notes, RowsInserted da duoc gop vao CREATE TABLE ETL\_RunLog o muc 7.4 ben duoi.
...
| Tag TenantID | Gắn tenant\_id vào mọi bản ghi từ bước Extract | Python (df\['TenantID'\]) | Mọi bản ghi Tenant A → TenantID='STORE\_HN' |
...
AS BEGIN
    ...
    \-- Transaction dam bao atomic: neu loi giua chung, rollback toan bo
...
Nạp/Cập nhật DimDate (chạy một lần, pre-populated, Shared)

Nạp/Cập nhật DimSupplier (Shared, không cần TenantID)

Nạp/Cập nhật DimProduct (SCD Type 2, Shared)

Nạp/Cập nhật DimCustomer (có TenantID)

Nạp/Cập nhật DimStore (có TenantID)

Nạp/Cập nhật DimEmployee (có TenantID)

Nạp FactSales (gọi usp\_Transform\_FactSales với @TenantID)

Nạp FactInventory (gọi usp\_Transform\_FactInventory với @TenantID)

Nạp FactPurchase (gọi usp\_Transform\_FactPurchase với @TenantID)

Refresh Data Mart (DM\_SalesSummary, DM\_InventoryAlert, DM\_CustomerRFM)

Cập nhật ETL\_Watermark và ghi ETL\_RunLog
...
# **CHƯƠNG 6: THIẾT KẾ HỆ THỐNG ĐA NGƯỜI DÙNG (MULTI-TENANT)**
...
## **6.5. Backup và Disaster Recovery**
...
│   │   ├── extract\_sales.py      \# Doc Excel, gan TenantID

│   │   └── extract\_inventory.py

│   ├── transform/

│   │   └── transform\_sales.py    \# Transform DataFrame

│   └── orchestrator/

│       └── main\_etl.py           \# Vong lap tenant, monitoring
...
│   │   ├── 01\_create\_tenants.sql      \# Tenants, AppUsers
...
│   │   ├── 05\_create\_datamart.sql     \# DM\_SalesSummary, DM\_CustomerRFM

│   │   └── 06\_add\_tenant\_id.sql       \# ALTER TABLE \+ INDEX

│   ├── sp/

│   │   ├── usp\_Load\_DimProduct.sql    \# SCD Type 2

│   │   ├── usp\_Load\_DimCustomer.sql   \# SCD Type 2 \+ TenantID

│   │   ├── usp\_Transform\_FactSales.sql \# Co @TenantID

│   │   └── usp\_Refresh\_DM\_\*.sql       \# Refresh Data Mart

│   └── views/

│       └── v\_FactSales\_ByTenant.sql   \# SESSION\_CONTEXT filter
...
│   ├── superset\_config.py             \# AUTH\_USER\_REGISTRATION=False

│   └── scripts/

│       └── create\_users.py            \# Tao users hang loat

│

├── monitoring/

│   └── monitoring.py                  \# Email \+ Slack alert

│

├── data/                              \# Thu muc du lieu theo tenant
...
├── docker-compose.yml                 \# Them service api
