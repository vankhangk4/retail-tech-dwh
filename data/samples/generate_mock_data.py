...
parser.add_argument("--seed", type=int, default=None, help="Random seed (default: current timestamp)")
parser.add_argument("--fresh", action="store_true", help="Generate with fresh random seed")
args = parser.parse_args()

seed = int(time.time()) if args.fresh or args.seed is None else args.seed
random.seed(seed)
np.random.seed(seed)
print(f"[mock_data] Using seed: {seed}")
